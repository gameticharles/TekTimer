...
export default function HomeScreen({ onSelect, onSettings }: HomeScreenProps) {
    return (
        <div className="h-screen w-screen bg-gray-950 flex flex-col items-center justify-center relative"
            ...
            <div className="flex gap-8">
                ...
                <button
                    ...
                    className="group relative w-80 p-8 rounded-2xl border border-gray-800 bg-gray-900/70 
                     hover:border-amber-500/60 hover:bg-gray-900 
                ...
                <button
                    ...
                    className="group relative w-80 p-8 rounded-2xl border border-gray-800 bg-gray-900/70 
                     hover:border-blue-500/60 hover:bg-gray-900 
                     transition-all duration-300 cursor-pointer text-left
