                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    ...
                    <label className="flex items-center gap-3 cursor-pointer group">
                        <input
                            ...
                            className="w-4 h-4 rounded border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-amber-500 
                         focus:ring-amber-500/20 focus:ring-offset-0 transition-colors"
                        />
