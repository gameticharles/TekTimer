...
export default function ProgressBar({
    ...
    const height = variant === 'fullwidth' ? 'h-3' : 'h-3'; // thicker for modern feel

    return (
        <div className={`w-full ${height} bg-gray-200 dark:bg-gray-800 rounded-full overflow-hidden transition-colors shadow-inner`}>
            <div
